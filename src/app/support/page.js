            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <strong>For Developer:</strong> Implement the Support page design from Figma here.
                  This page appears to have support options, contact information, and ways to get involved.
